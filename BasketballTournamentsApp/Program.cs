...
// your existing UserService is already registered in AddCrudServices — ensure it's registered as scoped/singleton as before
...
{
    c.SwaggerDoc("v1", new() { Title = "BasketballTournamentsApp", Version = "v1" });
